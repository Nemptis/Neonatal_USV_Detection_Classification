...
samplerate, data = wavfile.read('/Users/johannmaass/Desktop/Doktor/ZeTeM/Louisa/APP_2/MAGEL2BeispielErsteKohorte.WAV')

print(samplerate, len(data),len(data)/samplerate)
# spectrogram parameters
WINDOWLENGTH = 512    # 250 = 1ms
OVERLAP = 0
